...
| Goal | How | Cost | Notes |
| --- | --- | --- | --- |
| Show someone a finished chronicle | **GitHub Pages** (automatic) | free | `.github/workflows/pages.yml` publishes the showcase ledger's self-contained HTML export on every push to main. One-time setup: repo **Settings → Pages → Source: GitHub Actions**. Zero backend, zero risk. |
