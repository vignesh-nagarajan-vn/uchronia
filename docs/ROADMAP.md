...
- The Vercel chain is verified end to end locally and in CI against a faithful stage, but the next real "Import Project" on vercel.com is the final confirmation; import steps live in docs/DEPLOY.md.
