...
- *2026-07-23 · the 0.2 interaction pass.*
  ...
  - **Prev/next in event detail** as a quiet mono rail above the title, with terminal phrases ("the divergence is the beginning" / "the horizon, for now") instead of disabled arrows — dead ends should say where you are. Atlas / Timeline / Delta / Detail / Compare / Artifact reader captured and reviewed against §7.6:
