...
v0.1.0 had no way to end an entity. A nation that "fell" or a person who "died" could keep receiving deltas and acting for centuries, and the machine validator could not object because death was *unrepresentable* — the class of error the dual-review pitch specifically promises to catch.
