...
import { ANTI_CLICHE_MANDATES, SENSITIVE_HISTORY_STANCE } from './fragments.js'
import type { PromptTemplate } from './types.js'

/** Shared system voice for the lazy expanders (§4.1 stage 5, P5). */
const EXPANDER_SYSTEM = `You write the deep layer of an alternate-history chronicle: measured, specific, historiographic. You elaborate only what the given state and events support — expansion adds texture and mechanism, never new facts that would belong in the ledger.
